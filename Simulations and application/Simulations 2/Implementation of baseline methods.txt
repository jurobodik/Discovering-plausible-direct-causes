...
#If you want to run these lines, download the zip bQCD-master (also in https://github.com/tagas/bQCD.git) and set directory to it. 
...
setwd("C:/Users/jbodik/Desktop/Target variable identifiability/bQCD-master")#Setting directory to the downloaded zip bQCD-master.zip
